...
export function LoginForm({ onLogin, loading, error, onSwitchToRegister }) {
            ...
            >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="mt-2 flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-blue-500 to-indigo-500 px-4 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-blue-400 disabled:cursor-not-allowed disabled:opacity-60"
                    >
